...
const fallbackItems = [
    { id: 1, nama: 'XS' }, { id: 2, nama: 'S' }, { id: 3, nama: 'M' },
    { id: 4, nama: 'L' }, { id: 5, nama: 'XL' }, { id: 6, nama: 'XXL' },
    { id: 7, nama: 'XXXL' }, { id: 8, nama: 'D' },
];

const items = computed(() => props.ukuran?.data ?? fallbackItems);
