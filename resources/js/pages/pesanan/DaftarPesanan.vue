            ...
            <div v-if="isDetailOpen" class="fixed inset-0 z-50 flex items-center justify-center">
                ...
                <div class="relative bg-white text-black w-full max-w-xl mx-4 flex flex-col"
                    ...
                    <div
                        ...
                        <div>
                            <span class="text-black/40 uppercase">Status Pembayaran</span>
                            <div class="mt-0.5">{{ selectedItem?.statusPembayaran ?? '-' }}</div>
                        </div>
                        <div>
                            <span class="text-black/40 uppercase">Status Pesanan</span>
                            <div class="mt-0.5">{{ selectedItem?.statusPesanan ?? '-' }}</div>
                        </div>
                    </div>
